...
export default class MovieService {
    ...
    static async getMovies(page: number): Promise<IMovieAPIResponse> {
        return await HTTPService.get(`${API_URL}/movie?token=${API_KEY}&field=rating.kp&search=1-10&field=year&search=${getCurrentYear()}&page=${page}&sortField=year&sortType=1&selectFields=genres year name description alternativeName id poster rating`)
