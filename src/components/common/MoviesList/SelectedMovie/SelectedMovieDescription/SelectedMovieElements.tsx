...
const SelectedMovieElements: FC<SelectedMovieElementsProps> = ({movie}) => {
    ...
    const config = [
        ...
        },
        {
            ...
            condition: movie.productionCompanies?.length
        },
        {
            ...
            condition: getFilteredPersons("actor")
        },
        {
            title: "Режиссер",
            ...
            condition: getFilteredPersons("director")
        },
        {
            title: "Продюссер",
            ...
            condition: getFilteredPersons("producer"),
        }
    ];
